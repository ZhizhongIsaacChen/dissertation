...
There are two crucial steps in this algorithm:centrsampl the computation of $\VD(G)$ and
...
does not affect the running time of our algorithm:centrsampl for the construction of
