...
\begin{figure}[htbp]
  ...
  \hfill
  \subcaptionbox{Graph $G$ with $\VC(\range_G)=
...
%    \centering
%    \includegraphics[width=\textwidth,keepaspectratio]{centrsampl/figures/eps/tight-mapexample}
...
%  \begin{subfigure}[b]{0.3\textwidth}
%    \centering
%    \includegraphics[width=\textwidth,keepaspectratio]{centrsampl/figures/eps/tight}
...
%  \begin{subfigure}[b]{0.3\textwidth}
%    \centering
%    \includegraphics[width=\textwidth,keepaspectratio]{centrsampl/figures/eps/uniqueshortestpathtight}
