...
PARMA is an $\varepsilon$-approximation of the real set of frequent itemsets, we provide
...
happening, we refer again to Figure \ref{fig:breakdown1}. As expected,
...
\begin{comment}
In Figure \ref{fig:breakdown2}, a breakdown of total runtimes is shown
...
Figure~\ref{fig:breakdown2} we once again notice that the 5 million
...
Figure \ref{fig:frequency} shows the breakdown of PARMA runtimes as
...
Finally, in Figure~\ref{fig:confintwidth} we show the distribution of the widths
