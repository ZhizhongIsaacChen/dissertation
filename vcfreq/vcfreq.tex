...
\begin{theorem}\label{thm:vcfreqeapprox}
...
%$X$.
% of size $m$ as defined by Thm.~\ref{thm:vcfreqeapprox}. 
...
%Thm.~\ref{thm:vcfreqeapprox}, does not need the sample to be a uniform sample of the
%set of points.
%
