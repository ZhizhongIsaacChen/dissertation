...
%\subsection{Outline} 
\paragraph{Outline}
We review relevant previous work in Sect.~\ref{sec:prevwork}. In
Sect.~\ref{sec:prelim} we formally define the problem
...
through sampling are in Sect.~\ref{sec:approx}. Section~\ref{sec:exp} contains
an extensive experimental evaluation of our techniques. A discussion of our
results and the conclusions can be found in Sect.~\ref{sec:concl}.
