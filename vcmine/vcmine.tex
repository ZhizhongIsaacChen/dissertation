...
%~\cite{MannilaTV94,Toivonen96,ZakiPLO97,JiaL05,LiG04,ZhangZW03,ZhaoZZ06,BronnimanCDHS03,ChandraB11,ChenHS02,ChenHH11,ChuangCY05,HuY06,HwangK06,JiaG05,JohnL96,MahafzahABAZ09,Parthasarathy02,WangDC05,ChuangHC08,ChakaravarthyPS09,PietracaprinaV07,WangHLT05,PietracaprinaRUV10,SchefferW02,VasudevanV09}
...
\ctable[
  ...
  interestingness measures other than confidence.},
	...
	\tnote[$\dag$]{\cite{Toivonen96,JiaL05,LiG04,ZhangZW03}}
	\tnote[$\ddag$]{\cite{ChakaravarthyPS09}}
	\tnote[$\S$]{\cite{SchefferW02,PietracaprinaRUV10}}
	\tnote[$\P$]{\cite{ChakaravarthyPS09}}
	}{ \FL
    \toprule
...
element of the set~\cite{FordF62}. Computing the maximum matching can be done in
polynomial time~\cite{HopcroftK73}.
...
\begin{figure}[tp]
  ...
  $\delta=0.1$]{\label{fig:BMS-POS-absFI}\includegraphics[width=0.75\textwidth]{vcmine/Fig2a}}
 \hfill
  \subfloat[Relative Itemset Frequency
  Error, artificial dataset, $v=33$, $\theta=0.01$, $\varepsilon=0.05$,
  $\delta=0.1$]{\label{fig:artif-relFI}\includegraphics[width=0.75\textwidth]{vcmine/Fig2b}}
...
\begin{figure}[tp]
  ...
  Error]{\label{fig:artif-relAR-freq}\includegraphics[width=0.75\textwidth]{vcmine/Fig3a}}
  \hfill
  \subfloat[Relative Association Rule Confidence 
  Error]{\label{fig:artif-relAR-conf}\includegraphics[width=0.75\textwidth]{vcmine/Fig3b}}
...
\begin{figure}[tp]
  ...
  $\theta$,
  $\varepsilon=0.05$]{\label{fig:compareSamSizeTheta}\includegraphics[width=0.75\textwidth]{vcmine/Fig5a}}
  \hfill
  \subfloat[Sample size as function of
  $\varepsilon$,
  $\theta=0.05$]{\label{fig:compareSamSizeEpsilon}\includegraphics[width=0.75\textwidth]{vcmine/Fig5b}}
