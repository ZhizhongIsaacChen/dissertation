...
generated the dataset \emph{observed} by the researcher. In this work we are
...
We define a range set associated to a collection of itemsets and give an upper
...
%analyze our algorithm. We define a range set associated to a collection of
...
results of our experimental evaluation %of the test 
...
\fi
%omitted from this version of the paper, as are some
%experimental results. We refer the interested reader to the full version
%available online~\citep{RiondatoV13}.
