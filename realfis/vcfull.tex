...
$\varepsilon$-approximation to $(\range(\mathcal{B}),\pi)$ then %with probability at least $1-\delta$, then, if this is the case, 
...
$\VC(\range(2^\Itm))\le \ell-1$, a much stricter bound than $|\Itm|-1$ from
